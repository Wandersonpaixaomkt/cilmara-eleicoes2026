 ...
 * - Badge do número com hover que comunica profundidade
 */
export function Hero() {
  return (
    <section id="inicio" className="bg-white relative overflow-hidden">
      {/* Decoração sutil — orbs com blur; o overflow-hidden do section já evita transbordar */}
      <div
        aria-hidden
      ...
      <div className="relative container mx-auto px-4 md:px-6 max-w-6xl py-12 md:py-20 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          {/* Imagem — sem moldura, sem botões flutuantes sobrepostos */}
